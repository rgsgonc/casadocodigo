...
public class AppWebConfiguration {
	...
	/*Vamos criar um método chamado multipartResolver que retorna um objeto do tipo MultipartResolver. Este objeto 
	 * será instanciado da classe StandardServletMultipartResolver e retornado.*/
	@Bean
